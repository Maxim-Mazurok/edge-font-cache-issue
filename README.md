...
The workaround is to ask browser not to store cached CSS file that references the font file. See [workaround.js](./workaround.js) for example. Issue reproduction rate using workaround - 0/50 (0%).
